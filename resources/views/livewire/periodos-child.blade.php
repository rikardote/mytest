    ...
    <x:tall-crud-generator::dialog-modal wire:model="confirmingItemCreation">
        ...
        <x-slot name="content">
            <div class="mt-4">
                ...
                <x:tall-crud-generator::input class="block mt-1 w-1/2" type="text" wire:model.defer="item.periodo" />
                @error('item.periodo') <x:tall-crud-generator::error-message>{{$message}}</x:tall-crud-generator::error-message> @enderror
            </div>
            <div class="mt-4">
